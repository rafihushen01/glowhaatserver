...
exports.getSellerShopDecorator = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      modulecatalog: [
        { key: "single_banner", name: "Single Banner", max: 100, media: ["image", "gif"], notes: "Desktop 1920x500, Mobile 1080x720 recommended." },
        { key: "carousel_banner", name: "Carousel Banner", max: 100, media: ["image", "gif"], notes: "Upload 1-100 images and link products." },
        { key: "video_module", name: "Video Module", max: 10, media: ["video"], notes: "Brand story video module." },
        { key: "countdown_products", name: "Countdown Products", max: 3, media: ["none"], notes: "Up to 5 products per countdown block." },
        { key: "product_slider", name: "Product Slider", max: 20, media: ["none"], notes: "Highlight products in slider layout." },
        { key: "product_grid_three", name: "Three Column Product Grid", max: 20, media: ["none"], notes: "Desktop 3-column responsive module." },
        { key: "banner_four", name: "4 Banner Module", max: 100, media: ["image", "gif"], notes: "Upload up to 100 images." },
        { key: "banner_five", name: "5 Banner Module", max: 100, media: ["image", "gif"], notes: "Upload up to 100 images." },
      ],
      previewurls: {
        desktop: `/shop/${shop.slug}?preview=desktop`,
        tablet: `/shop/${shop.slug}?preview=tablet`,
